...
export default function TitleHeader({...props}:Props){
    ...
    return (
        <div>
            <h1 className={style.title}><Image src="./logo.svg" alt="logo" width={20} height={20} style={{display: allLogoRoute.includes(router.pathname) ? "inline" : "none", margin: "0 0.5rem", verticalAlign: "baseline"}} />{props.title}</h1>
